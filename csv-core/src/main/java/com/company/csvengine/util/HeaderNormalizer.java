...
public final class HeaderNormalizer {
    ...
    public static Map<String, Integer> resolveColumnIndexes(String[] headers) {
        return resolveColumnIndexes(headers == null ? null : Arrays.asList(headers), CsvColumnMappingConfig.defaults());
    }

    public static Map<String, Integer> resolveColumnIndexes(List<String> headers) {
        return resolveColumnIndexes(headers, CsvColumnMappingConfig.defaults());
    }

    public static Map<String, Integer> resolveColumnIndexes(
            List<String> headers,
            CsvColumnMappingConfig metadataConfig) {
        if (headers == null || headers.isEmpty()) {
            return Collections.emptyMap();
        }
        CsvColumnMappingConfig config = metadataConfig == null ? CsvColumnMappingConfig.defaults() : metadataConfig;
        CsvColumnMappingConfig.ColumnMapping mapping = config.getColumnMapping();
